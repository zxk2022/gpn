...
class ShapeNetSkelDataset(InMemoryDataset):
    def __init__(
        self,
        root: str,
        graph_type: str,
        ...
        super(ShapeNetSkelDataset, self).__init__(root, transform, pre_transform, pre_filter)
    ...
    def processed_file_names(self) -> str:
        return f'data_{self.graph_type}.pt'
